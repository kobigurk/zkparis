...
console.log("element(" + animations[fragment][i].element + ")." + animations[fragment][i].modifier + "(" + JSON.stringify(animations[fragment][i].parameters) + ")");
						if ( !elements.length ) {
						...
						for (var j = 0; j < elements.length; j++ ){
							...
							console.warn('parameters', animations[fragment][i].parameters);
